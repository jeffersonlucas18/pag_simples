        ...
        templates: {
            buttons: function() {
                ...
                return '<div class="wizard-buttons">' +
                    ...
                    //'<a class="wizard-finish btn btn-rounded btn-danger waves-effect waves-light btn-rounded font-18 pull-right font-light" href="#' + this.id + '" data-wizard="finish" role="button">' + options.buttonLabels.finish + '</a>' +
                    '</div>';
            }
        },
